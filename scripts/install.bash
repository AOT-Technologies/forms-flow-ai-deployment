...
# Path to the file containing tested Docker versions
tested_versions_file="tested_versions.txt"

# Check if the file exists
if [ ! -f "$tested_versions_file" ]; then
    echo "Tested Docker versions file not found: $tested_versions_file"
    exit 1
fi

# Read valid versions from the file into an array
mapfile -t tested_versions.txt < "$tested_versions_file"
