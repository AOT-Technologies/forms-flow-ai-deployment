...
echo MF_FORMSFLOW_WEB_URL=https://forms-flow-microfrontends.aot-technologies.com/!MF_WEB_PATH!@v8.1.0-alpha/forms-flow-web.gz.js
echo MF_FORMSFLOW_NAV_URL=https://forms-flow-microfrontends.aot-technologies.com/forms-flow-nav@v8.1.0-alpha/forms-flow-nav.gz.js
echo MF_FORMSFLOW_SERVICE_URL=https://forms-flow-microfrontends.aot-technologies.com/forms-flow-service@v8.1.0-alpha/forms-flow-service.gz.js
echo MF_FORMSFLOW_COMPONENTS_URL=https://forms-flow-microfrontends.aot-technologies.com/forms-flow-components@v8.1.0-alpha/forms-flow-components.gz.js
echo MF_FORMSFLOW_ADMIN_URL=https://forms-flow-microfrontends.aot-technologies.com/forms-flow-admin@v8.1.0-alpha/forms-flow-admin.gz.js
echo MF_FORMSFLOW_REVIEW_URL=https://forms-flow-microfrontends.aot-technologies.com/forms-flow-review@v8.1.0-alpha/forms-flow-review.gz.js
echo MF_FORMSFLOW_SUBMISSIONS_URL=https://forms-flow-microfrontends.aot-technologies.com/forms-flow-submissions@v8.1.0-alpha/forms-flow-submissions.gz.js
echo.
...
echo.
echo # Keycloak - HubSpot Integration
echo #HUBSPOT_ACCESS_TOKEN=
echo #HUBSPOT_PIPELINE_ID=
echo #HUBSPOT_DEAL_STAGE_ID=
echo #HUBSPOT_DEAL_OWNER_ID=
echo HUBSPOT_DEAL_SOURCE=FFAI Try It Now form
echo HUBSPOT_BASE_URL=https://api.hubapi.com 
echo HUBSPOT_ENABLED=false
echo FF_KEYCLOAK_PUBLIC_URL=http://!ip_add!:8080/auth
echo FF_ADMIN_API_URL=http://!ip_add!:5010/api/v1
echo.
echo # API URLs
...
echo.
echo # Web - URL Configuration
echo URL_UPGRADE=https://formsflow.ai/license-upgrade-call-scheduler/
